...
*/
	...
	public Calculator() {
		...
		button_multiply.setBounds(336, 82, 41, 29);
		...
		button_divide.setBounds(336, 112, 41, 29);
		contentPane.add(button_divide);
		button_plus.setBounds(290, 82, 41, 29);
		...
		button_minus.setBounds(290, 112, 41, 29);
		...
		button_equal.setBounds(336, 142, 41, 29);
		...
		button_clear.setBackground(Color.GRAY);
		button_clear.setBounds(389, 136, 41, 40);
